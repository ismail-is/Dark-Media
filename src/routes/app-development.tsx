...
export const Route = createFileRoute('/app-development')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: "Custom Android, iOS & cross-platform app development for startups & enterprises. Mangalore · Bangalore · Dubai." },
  ...
  {
    "type": "application/ld+json",
    "children": "{\"@context\":\"https://schema.org\",\"@type\":\"FAQPage\",\"mainEntity\":[{\"@type\":\"Question\",\"name\":\"Should I build native or cross-platform?\",\"acceptedAnswer\":{\"@type\":\"Answer\",\"text\":\"Depends on budget and features — we'll advise based on your specific app idea.\"}},{\"@type\":\"Question\",\"name\":\"Do you offer post-launch support?\",\"acceptedAnswer\":{\"@type\":\"Answer\",\"text\":\"Yes, maintenance plans are available.\"}}]}"
  }
]
  }),
    ...
    <SharedLayout>
      ...
      >
        <div className="prose prose-invert prose-lg max-w-none prose-headings:font-display">
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">From idea to App Store launch, Dark Media builds custom mobile apps for startups and businesses across Mangalore, Bangalore, and Dubai — Android, iOS, or cross-platform.</p>
<h2 className="font-display text-3xl md:text-4xl font-semibold mt-16 mb-8 text-[#F5F5F4] border-b border-[#F5F5F4]/10 pb-4">Our App Development Process</h2>
...
<p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light"><em className="text-[#F5F5F4]/90 not-italic font-medium block mt-6 mb-2">Should I build native or cross-platform?</em> Depends on budget and features — we'll advise based on your specific app idea.</p>
<p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light"><em className="text-[#F5F5F4]/90 not-italic font-medium block mt-6 mb-2">Do you offer post-launch support?</em> Yes, maintenance plans are available.</p>
