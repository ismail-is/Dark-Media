  ...
  head: () => ({
    meta: [
      ...
      { title: "Branding & Logo Design Agency in Bangalore | Dark Media" },
      {
        name: "description",
        content:
          "Build a brand that stands out — strategy, logo & identity design for Bangalore companies.",
      },
      ...
      >
        <div className="prose prose-invert prose-lg max-w-none prose-headings:font-display">
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            In a market as crowded as Bangalore's, a distinctive brand identity is what makes
            customers remember you. We build brand systems designed to stand out and stay consistent
            everywhere.
          </p>
