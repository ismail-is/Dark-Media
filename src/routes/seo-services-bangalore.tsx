...
export const Route = createFileRoute('/seo-services-bangalore')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: "Bangalore's trusted SEO agency — keyword research, link building & local SEO for measurable growth." },
    ...
    <SharedLayout>
      ...
      >
        <div className="prose prose-invert prose-lg max-w-none prose-headings:font-display">
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">Bangalore has thousands of businesses competing for the same searches. Dark Media's SEO process is built around actual keyword data and competitor analysis, not guesswork.</p>
<h2 className="font-display text-3xl md:text-4xl font-semibold mt-16 mb-8 text-[#F5F5F4] border-b border-[#F5F5F4]/10 pb-4">Our SEO Process</h2>
...
<p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light"><em className="text-[#F5F5F4]/90 not-italic font-medium block mt-6 mb-2">Do you work with ecommerce sites?</em> Yes — we handle SEO for both service businesses and online stores.</p>
<p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light"><em className="text-[#F5F5F4]/90 not-italic font-medium block mt-6 mb-2">What tools do you use?</em> Industry-standard tools for keyword tracking, technical audits, and competitor benchmarking.</p>
