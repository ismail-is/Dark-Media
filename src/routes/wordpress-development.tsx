  ...
  head: () => ({
    meta: [
      ...
      { title: "WordPress Website Developer | Custom WordPress Design | Dark Media" },
      {
        name: "description",
        content:
          "Expert WordPress developers — custom themes, plugins, speed optimisation & migrations for businesses in India & UAE.",
      },
      {
        property: "og:title",
        content: "WordPress Website Developer | Custom WordPress Design | Dark Media",
      },
      {
      ...
      >
        <div className="prose prose-invert prose-lg max-w-none prose-headings:font-display">
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            WordPress powers over 40% of the web — and when built right, it's fast, flexible, and
            easy to manage yourself. Dark Media builds custom WordPress websites, not bloated
            template installs.
          </p>
          ...
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            ...
            Yes — we build with an easy-to-use editor so you can manage content without a developer.
          </p>
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            <em className="text-[#F5F5F4]/90 not-italic font-medium block mt-6 mb-2">
              Do you offer maintenance after launch?
            </em>{" "}
            Yes, ongoing plans are available.
          </p>
