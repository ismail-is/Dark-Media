...
export const Route = createFileRoute('/ecommerce-website-development-bangalore')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: "Online store design & development in Bangalore — secure payments, mobile-first, built to sell." },
    ...
    <SharedLayout>
      ...
      >
        <div className="prose prose-invert prose-lg max-w-none prose-headings:font-display">
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">Bangalore's online shoppers expect a fast, trustworthy checkout experience. We build ecommerce websites for Bangalore brands that are mobile-first and optimised to convert.</p>
