  ...
  head: () => ({
    meta: [
      ...
      { title: "Digital Marketing Company in Bangalore | Dark Media" },
      {
        name: "description",
        content:
          "Result-driven digital marketing agency in Bangalore — SEO, ads, content & social media that convert. Get a free audit.",
      },
      ...
      >
        <div className="prose prose-invert prose-lg max-w-none prose-headings:font-display">
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            Bangalore's market is competitive and fast-moving — startups, D2C brands, and
            established companies are all fighting for the same search results and ad space. Dark
            Media builds performance-focused digital marketing campaigns designed for that
            competition.
          </p>
          ...
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            We don't sell one-size-fits-all packages. Every Bangalore client gets a custom strategy
            based on their industry, competitors, and growth stage — whether that's a SaaS startup
            or a retail chain.
          </p>
          ...
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            ...
            We've worked across tech, retail, F&B, and services — happy to share relevant case
            studies on a call.
          </p>
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            <em className="text-[#F5F5F4]/90 not-italic font-medium block mt-6 mb-2">
              Can you manage both SEO and paid ads together?
            </em>{" "}
            Yes, and we recommend it — the two channels perform better combined.
          </p>
