...
export const Route = createFileRoute('/ui-ux-design')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: "User-centred UI/UX design for websites & apps that's beautiful and easy to use." },
    ...
    scripts: [
  {
    ...
    "children": "{\"@context\":\"https://schema.org\",\"@type\":\"ProfessionalService\",\"name\":\"Dark Media\",\"description\":\"User-centred UI/UX design for websites & apps that's beautiful and easy to use.\",\"url\":\"https://darkmedia.tech/ui-ux-design\",\"telephone\":\"+919480889252\",\"email\":\"hello@darkmedia.tech\",\"image\":\"https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/97979928-1e7f-4a22-b4cf-e7db2e95207b/id-preview-f1a7a5f9--67fbfdeb-ef3a-43b8-a184-79622d436225.lovable.app-1781074340903.png\"}"
  }
]
  }),
    ...
    <SharedLayout>
      ...
      >
        <div className="prose prose-invert prose-lg max-w-none prose-headings:font-display">
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">Good design isn't just how something looks — it's how easily people can use it. Dark Media designs interfaces for websites and apps focused on usability and conversion.</p>
...
<div className="mt-16 text-center">
        <a href="tel:+919480889252" className="inline-flex items-center justify-center rounded-full bg-[#F5F5F4] text-[#030304] px-10 py-5 text-lg font-medium hover:bg-white hover:scale-105 active:scale-95 transition-all shadow-[0_0_40px_rgba(255,255,255,0.1)]">
          Get a Free UI/UX Consultation &rarr;
        </a>
      </div>
