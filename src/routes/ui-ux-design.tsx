...
export const Route = createFileRoute("/ui-ux-design")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "User-centred UI/UX design for websites & apps that's beautiful and easy to use.",
      },
      ...
      >
        <div className="prose prose-invert prose-lg max-w-none prose-headings:font-display">
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            Good design isn't just how something looks — it's how easily people can use it. Dark
            Media designs interfaces for websites and apps focused on usability and conversion.
          </p>
