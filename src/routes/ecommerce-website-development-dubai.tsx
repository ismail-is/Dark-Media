...
export const Route = createFileRoute('/ecommerce-website-development-dubai')({
  head: () => ({
    meta: [
      { title: "Ecommerce Website Development in Dubai | Dark Media" },
      { name: 'description', content: "UAE ecommerce store development with local payment gateway integration & Arabic/English support." },
    ...
    scripts: [
  {
    ...
    "children": "{\"@context\":\"https://schema.org\",\"@type\":\"LocalBusiness\",\"name\":\"Dark Media\",\"description\":\"UAE ecommerce store development with local payment gateway integration & Arabic/English support.\",\"url\":\"https://darkmedia.tech/ecommerce-website-development-dubai\",\"telephone\":\"+919480889252\",\"email\":\"hello@darkmedia.tech\",\"image\":\"https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/97979928-1e7f-4a22-b4cf-e7db2e95207b/id-preview-f1a7a5f9--67fbfdeb-ef3a-43b8-a184-79622d436225.lovable.app-1781074340903.png\",\"address\":{\"@type\":\"PostalAddress\",\"addressLocality\":\"Dubai\",\"addressCountry\":\"AE\"}}"
  }
]
  }),
...
function PageComponent() {
  return (
    <SharedLayout>
      <HeroBanner title={"Ecommerce Website Development in Dubai"} />
      ...
      >
        <div className="prose prose-invert prose-lg max-w-none prose-headings:font-display">
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">Selling online in the UAE means integrating local payment gateways and building trust with an international customer base. Dark Media builds ecommerce stores designed for the Dubai market.</p>
