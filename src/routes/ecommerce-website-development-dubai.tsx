  ...
  head: () => ({
    meta: [
      ...
      { title: "Ecommerce Website Development in Dubai | Dark Media" },
      {
        name: "description",
        content:
          "UAE ecommerce store development with local payment gateway integration & Arabic/English support.",
      },
      ...
      >
        <div className="prose prose-invert prose-lg max-w-none prose-headings:font-display">
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            Selling online in the UAE means integrating local payment gateways and building trust
            with an international customer base. Dark Media builds ecommerce stores designed for the
            Dubai market.
          </p>
