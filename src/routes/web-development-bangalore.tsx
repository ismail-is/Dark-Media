  ...
  head: () => ({
    meta: [
      ...
      { title: "Web Design & Development Company in Bangalore | Dark Media" },
      {
        name: "description",
        content:
          "Professional website design & development agency in Bangalore — responsive, fast, SEO-optimised.",
      },
      {
        property: "og:title",
        content: "Web Design & Development Company in Bangalore | Dark Media",
      },
      {
      ...
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://darkmedia.tech/web-development-bangalore" },
      ...
      { rel: "canonical", href: "https://darkmedia.tech/web-development-bangalore" },
      ...[
        { name: "geo.region", content: "IN-KA" },
    ...
    scripts: [
      ...
      },
      {
        type: "application/ld+json",
        children:
          '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Do you build on WordPress or custom code?","acceptedAnswer":{"@type":"Answer","text":"Both — we recommend the right stack based on your needs and budget."}}]}',
      },
    ],
  }),
      ...
      >
        <div className="prose prose-invert prose-lg max-w-none prose-headings:font-display">
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            From startups to established brands, Dark Media designs and develops websites for
            Bangalore businesses that need to look credible and perform technically — fast load
            times, clean code, and SEO built in.
          </p>
          ...
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            ...
            Both — we recommend the right stack based on your needs and budget.
          </p>
