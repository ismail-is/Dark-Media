...
export const Route = createFileRoute('/software-development')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: "Enterprise & startup software solutions — SaaS, automation tools & custom platforms built to scale." },
    ...
    scripts: [
  {
    ...
    "children": "{\"@context\":\"https://schema.org\",\"@type\":\"ProfessionalService\",\"name\":\"Dark Media\",\"description\":\"Enterprise & startup software solutions — SaaS, automation tools & custom platforms built to scale.\",\"url\":\"https://darkmedia.tech/software-development\",\"telephone\":\"+919480889252\",\"email\":\"hello@darkmedia.tech\",\"image\":\"https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/97979928-1e7f-4a22-b4cf-e7db2e95207b/id-preview-f1a7a5f9--67fbfdeb-ef3a-43b8-a184-79622d436225.lovable.app-1781074340903.png\"}"
  },
  {
    "type": "application/ld+json",
    "children": "{\"@context\":\"https://schema.org\",\"@type\":\"FAQPage\",\"mainEntity\":[{\"@type\":\"Question\",\"name\":\"Do you build MVPs for startups?\",\"acceptedAnswer\":{\"@type\":\"Answer\",\"text\":\"Yes, we specialise in fast, functional MVPs to validate ideas before scaling.\"}}]}"
  }
]
  }),
...
function PageComponent() {
  return (
    <SharedLayout>
      <HeroBanner title={"Custom Software Development Company"} />
      ...
      >
        <div className="prose prose-invert prose-lg max-w-none prose-headings:font-display">
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">When off-the-shelf tools don't fit your workflow, Dark Media builds custom software — internal tools, SaaS platforms, and automation systems tailored to your business.</p>
...
<p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light"><em className="text-[#F5F5F4]/90 not-italic font-medium block mt-6 mb-2">Do you build MVPs for startups?</em> Yes, we specialise in fast, functional MVPs to validate ideas before scaling.</p>
<div className="mt-16 text-center">
        <a href="tel:+919480889252" className="inline-flex items-center justify-center rounded-full bg-[#F5F5F4] text-[#030304] px-10 py-5 text-lg font-medium hover:bg-white hover:scale-105 active:scale-95 transition-all shadow-[0_0_40px_rgba(255,255,255,0.1)]">
          Get a Free Software Consultation &rarr;
        </a>
      </div>
