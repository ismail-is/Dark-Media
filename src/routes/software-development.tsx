  ...
  head: () => ({
    meta: [
      ...
      { title: "Custom Software Development Company | Dark Media" },
      {
        name: "description",
        content:
          "Enterprise & startup software solutions — SaaS, automation tools & custom platforms built to scale.",
      },
    ...
    scripts: [
      ...
      },
      {
        type: "application/ld+json",
        children:
          '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Do you build MVPs for startups?","acceptedAnswer":{"@type":"Answer","text":"Yes, we specialise in fast, functional MVPs to validate ideas before scaling."}}]}',
      },
    ],
  }),
      ...
      >
        <div className="prose prose-invert prose-lg max-w-none prose-headings:font-display">
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            When off-the-shelf tools don't fit your workflow, Dark Media builds custom software —
            internal tools, SaaS platforms, and automation systems tailored to your business.
          </p>
          ...
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            ...
            Yes, we specialise in fast, functional MVPs to validate ideas before scaling.
          </p>
