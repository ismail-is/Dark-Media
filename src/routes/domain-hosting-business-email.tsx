  ...
  head: () => ({
    meta: [
      ...
      { title: "Domain Registration, Business Email & Hosting Setup | Dark Media" },
      {
        name: "description",
        content:
          "Get your domain, professional business email (@yourcompany.com) & fast hosting set up — done for you.",
      },
      {
        property: "og:title",
        content: "Domain Registration, Business Email & Hosting Setup | Dark Media",
      },
      {
    ...
    scripts: [
      ...
      },
      {
        type: "application/ld+json",
        children:
          '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Can I keep my existing domain?","acceptedAnswer":{"@type":"Answer","text":"Yes, we can transfer or connect an existing domain."}},{"@type":"Question","name":"Is business email really necessary?","acceptedAnswer":{"@type":"Answer","text":"Yes — it builds trust and looks more professional than a free Gmail address for business use."}}]}',
      },
    ],
  }),
      ...
      >
        <div className="prose prose-invert prose-lg max-w-none prose-headings:font-display">
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            Every business needs a professional foundation online — a domain, business email that
            matches it (like you@yourcompany.com), and reliable hosting. We handle the technical
            setup so you don't have to.
          </p>
          ...
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            ...
            Yes, we can transfer or connect an existing domain.
          </p>
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            <em className="text-[#F5F5F4]/90 not-italic font-medium block mt-6 mb-2">
              Is business email really necessary?
            </em>{" "}
            Yes — it builds trust and looks more professional than a free Gmail address for business
            use.
          </p>
