  ...
  head: () => ({
    meta: [
      ...
      { title: "Videography & Video Production Company in Mangalore | Dark Media" },
      {
        name: "description",
        content:
          "Corporate, brand & promotional video production in Mangalore. Professional crew, fast turnaround.",
      },
      {
        property: "og:title",
        content: "Videography & Video Production Company in Mangalore | Dark Media",
      },
      {
      ...
      >
        <div className="prose prose-invert prose-lg max-w-none prose-headings:font-display">
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            Video converts better than almost any other content format. Dark Media produces
            corporate, promotional, and brand videos for Mangalore businesses — from concept to
            final edit.
          </p>
