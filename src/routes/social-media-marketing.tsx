  ...
  head: () => ({
    meta: [
      ...
      { title: "Social Media Marketing Agency | Dark Media" },
      {
        name: "description",
        content:
          "Grow your brand on Instagram, Facebook & LinkedIn with strategy-led social media management.",
      },
      ...
      >
        <div className="prose prose-invert prose-lg max-w-none prose-headings:font-display">
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            Posting randomly doesn't build a following — a content strategy does. Dark Media manages
            social media for businesses across Mangalore, Bangalore, and Dubai with a plan behind
            every post.
          </p>
