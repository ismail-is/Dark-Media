...
export const Route = createFileRoute('/social-media-marketing')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: "Grow your brand on Instagram, Facebook & LinkedIn with strategy-led social media management." },
    ...
    scripts: [
  {
    ...
    "children": "{\"@context\":\"https://schema.org\",\"@type\":\"ProfessionalService\",\"name\":\"Dark Media\",\"description\":\"Grow your brand on Instagram, Facebook & LinkedIn with strategy-led social media management.\",\"url\":\"https://darkmedia.tech/social-media-marketing\",\"telephone\":\"+919480889252\",\"email\":\"hello@darkmedia.tech\",\"image\":\"https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/97979928-1e7f-4a22-b4cf-e7db2e95207b/id-preview-f1a7a5f9--67fbfdeb-ef3a-43b8-a184-79622d436225.lovable.app-1781074340903.png\"}"
  }
]
  }),
...
function PageComponent() {
  return (
    <SharedLayout>
      <HeroBanner title={"Social Media Marketing Agency"} />
      ...
      >
        <div className="prose prose-invert prose-lg max-w-none prose-headings:font-display">
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">Posting randomly doesn't build a following — a content strategy does. Dark Media manages social media for businesses across Mangalore, Bangalore, and Dubai with a plan behind every post.</p>
