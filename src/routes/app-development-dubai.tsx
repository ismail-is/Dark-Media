...
export const Route = createFileRoute('/app-development-dubai')({
  head: () => ({
    meta: [
      { title: "App Development Company in Dubai | Dark Media" },
      { name: 'description', content: "iOS & Android app development for UAE businesses — scalable, secure, and App Store ready." },
    ...
    scripts: [
  {
    ...
    "children": "{\"@context\":\"https://schema.org\",\"@type\":\"LocalBusiness\",\"name\":\"Dark Media\",\"description\":\"iOS & Android app development for UAE businesses — scalable, secure, and App Store ready.\",\"url\":\"https://darkmedia.tech/app-development-dubai\",\"telephone\":\"+919480889252\",\"email\":\"hello@darkmedia.tech\",\"image\":\"https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/97979928-1e7f-4a22-b4cf-e7db2e95207b/id-preview-f1a7a5f9--67fbfdeb-ef3a-43b8-a184-79622d436225.lovable.app-1781074340903.png\",\"address\":{\"@type\":\"PostalAddress\",\"addressLocality\":\"Dubai\",\"addressCountry\":\"AE\"}}"
  }
]
  }),
...
function PageComponent() {
  return (
    <SharedLayout>
      <HeroBanner title={"App Development Company in Dubai"} />
      ...
      >
        <div className="prose prose-invert prose-lg max-w-none prose-headings:font-display">
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">We build secure, scalable mobile apps for Dubai businesses — from retail and services to logistics and fintech-adjacent use cases.</p>
