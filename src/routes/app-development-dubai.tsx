  ...
  head: () => ({
    meta: [
      ...
      { title: "App Development Company in Dubai | Dark Media" },
      {
        name: "description",
        content:
          "iOS & Android app development for UAE businesses — scalable, secure, and App Store ready.",
      },
      ...
      >
        <div className="prose prose-invert prose-lg max-w-none prose-headings:font-display">
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            We build secure, scalable mobile apps for Dubai businesses — from retail and services to
            logistics and fintech-adjacent use cases.
          </p>
