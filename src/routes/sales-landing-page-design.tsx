...
export const Route = createFileRoute('/sales-landing-page-design')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: "High-converting sales pages & landing pages designed to turn traffic into leads and customers." },
  ...
  {
    "type": "application/ld+json",
    "children": "{\"@context\":\"https://schema.org\",\"@type\":\"FAQPage\",\"mainEntity\":[{\"@type\":\"Question\",\"name\":\"Do you write the copy too?\",\"acceptedAnswer\":{\"@type\":\"Answer\",\"text\":\"Yes, conversion-focused copywriting is included.\"}},{\"@type\":\"Question\",\"name\":\"Can this integrate with my ad campaigns?\",\"acceptedAnswer\":{\"@type\":\"Answer\",\"text\":\"Yes — we build pages specifically to pair with Google/Meta Ads.\"}}]}"
  }
]
  }),
    ...
    <SharedLayout>
      ...
      >
        <div className="prose prose-invert prose-lg max-w-none prose-headings:font-display">
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">A landing page has one job: convert. Dark Media designs focused, fast-loading sales pages built around a single clear action — sign up, buy, or book a call.</p>
...
<p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light"><em className="text-[#F5F5F4]/90 not-italic font-medium block mt-6 mb-2">Do you write the copy too?</em> Yes, conversion-focused copywriting is included.</p>
<p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light"><em className="text-[#F5F5F4]/90 not-italic font-medium block mt-6 mb-2">Can this integrate with my ad campaigns?</em> Yes — we build pages specifically to pair with Google/Meta Ads.</p>
