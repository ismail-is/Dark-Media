...
function StackingSection({
  ...
  return (
    <div
      ...
      className={`${
        isMobile
          ? "relative h-auto py-6 md:py-8 px-4 md:px-8"
...
function AlMasoudiPage() {
  ...
  return (
    <main
      ref={containerRef}
      className="relative bg-[#030304] text-[#030304] font-sans selection:bg-[#EC6303] selection:text-white"
    >
      <LocalCursor />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 items-center my-auto">
            ...
            <div className="lg:col-span-6 flex flex-col justify-center">
              <div className="mb-3 md:mb-4 flex items-center gap-2">
                ...
                <span className="text-[10px] md:text-xs uppercase tracking-[0.25em] text-[#EC6303] font-semibold">
                  Featured Work
                </span>
              </div>
              ...
              <p className="text-white/70 text-sm md:text-base lg:text-lg leading-relaxed max-w-xl mb-6 md:mb-8">
                A premium brand identity designed for AL MASOUDI Contracting and Trading. Combining
                clean, modern geometry with industrial heritage to reflect strength, precision, and
              ...
              <div className="grid grid-cols-3 gap-4 border-t border-white/10 pt-4 md:pt-6 max-w-lg">
                <div>
                  <div className="text-[9px] md:text-[10px] uppercase tracking-wider text-white/40 mb-1">
                    Client
                  </div>
            ...
            <div className="lg:col-span-6 relative flex justify-center items-center h-[240px] sm:h-[340px] lg:h-[400px] xl:h-[450px]">
              <div className="relative w-full h-full rounded-2xl md:rounded-3xl overflow-hidden shadow-2xl border border-white/10 group bg-white/5">
                ...
                <div className="absolute bottom-4 left-4 md:bottom-6 md:left-6 right-4 md:right-6">
                  <span className="text-[9px] md:text-[10px] font-mono uppercase tracking-widest text-white/50 block mb-0.5">
                    Primary Showcase
                  </span>
                  <span className="text-white text-xs md:text-sm font-medium">
                    Corporate stationery design & brand application
                  </span>
                </div>
              </div>
            </div>
        ...
        <section className="px-4 sm:px-6 md:px-10 lg:p-[220px] py-10 md:py-16 lg:py-20 relative z-10 bg-[#F5F5F4] w-full rounded-[24px] md:rounded-[32px] lg:rounded-t-[48px] lg:rounded-b-none shadow-2xl border border-black/5 lg:border-t lg:border-x-0 lg:border-b-0">
          <div className="max-w-[1600px] mx-auto w-full">
            ...
            <div className="mt-12 border-t border-[#030304]/10 pt-6 flex justify-between items-center">
              <Link
                to="/portfolio"
                className="group inline-flex items-center gap-3 rounded-full bg-[#030304] text-[#F5F5F4] px-8 py-4 text-[12px] uppercase tracking-[0.22em] shadow-soft hover:shadow-deep transition-all duration-300"
              >
                <ArrowLeft className="w-4 h-4 transition-transform duration-300 group-hover:-translate-x-1" />
