...
export const Route = createFileRoute('/ecommerce-website-development')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: "Build a high-converting online store — Shopify, WooCommerce & custom ecommerce development for Mangalore, Bangalore & Dubai." },
  ...
  {
    "type": "application/ld+json",
    "children": "{\"@context\":\"https://schema.org\",\"@type\":\"FAQPage\",\"mainEntity\":[{\"@type\":\"Question\",\"name\":\"Shopify or WooCommerce — which is better?\",\"acceptedAnswer\":{\"@type\":\"Answer\",\"text\":\"Depends on your budget, product range, and long-term plans — we'll recommend the right fit on a call.\"}},{\"@type\":\"Question\",\"name\":\"Can you migrate my existing store?\",\"acceptedAnswer\":{\"@type\":\"Answer\",\"text\":\"Yes, we handle migrations with minimal downtime.\"}}]}"
  }
]
  }),
    ...
    <SharedLayout>
      ...
      >
        <div className="prose prose-invert prose-lg max-w-none prose-headings:font-display">
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">An online store needs more than good design — it needs secure checkout, fast load times, and a layout built to convert browsers into buyers. Dark Media builds ecommerce sites on Shopify, WooCommerce, or custom platforms depending on your needs.</p>
...
<p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light"><em className="text-[#F5F5F4]/90 not-italic font-medium block mt-6 mb-2">Shopify or WooCommerce — which is better?</em> Depends on your budget, product range, and long-term plans — we'll recommend the right fit on a call.</p>
<p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light"><em className="text-[#F5F5F4]/90 not-italic font-medium block mt-6 mb-2">Can you migrate my existing store?</em> Yes, we handle migrations with minimal downtime.</p>
