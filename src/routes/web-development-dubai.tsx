  ...
  head: () => ({
    meta: [
      ...
      { title: "Website Development Company in Dubai | Dark Media" },
      {
        name: "description",
        content:
          "UAE-focused website design & development — bilingual, fast, and built for local search.",
      },
      ...
      >
        <div className="prose prose-invert prose-lg max-w-none prose-headings:font-display">
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            Dark Media designs and builds websites for Dubai businesses that need to perform across
            a diverse, international customer base — fast, clean, and search-optimised for the UAE
            market.
          </p>
