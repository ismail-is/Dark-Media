  ...
  head: () => ({
    meta: [
      ...
      { title: "Website Maintenance & Support Plans | Dark Media" },
      {
        name: "description",
        content:
          "Ongoing website updates, security monitoring & speed optimisation — keep your site running smoothly.",
      },
      ...
      >
        <div className="prose prose-invert prose-lg max-w-none prose-headings:font-display">
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            A website isn't a one-time project — it needs updates, security patches, and monitoring.
            Dark Media offers ongoing maintenance plans so your site stays fast and secure.
          </p>
