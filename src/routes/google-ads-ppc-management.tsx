  ...
  head: () => ({
    meta: [
      ...
      { title: "Google Ads & PPC Management Services | Dark Media" },
      {
        name: "description",
        content:
          "Certified PPC experts running high-ROI Google Ads campaigns for businesses in India & UAE.",
      },
      ...
      >
        <div className="prose prose-invert prose-lg max-w-none prose-headings:font-display">
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            Paid ads can bring immediate traffic — but only when set up correctly. Dark Media
            manages Google Ads and Meta Ads campaigns focused on return on ad spend, not just
            clicks.
          </p>
