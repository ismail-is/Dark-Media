...
export const Route = createFileRoute('/wordpress-development-mangalore')({
  head: () => ({
    meta: [
      { title: "WordPress Developer in Mangalore | Dark Media" },
      { name: 'description', content: "Affordable, professional WordPress website development in Mangalore. Fast delivery, SEO-friendly builds." },
    ...
    scripts: [
  {
    ...
    "children": "{\"@context\":\"https://schema.org\",\"@type\":\"LocalBusiness\",\"name\":\"Dark Media\",\"description\":\"Affordable, professional WordPress website development in Mangalore. Fast delivery, SEO-friendly builds.\",\"url\":\"https://darkmedia.tech/wordpress-development-mangalore\",\"telephone\":\"+919480889252\",\"email\":\"hello@darkmedia.tech\",\"image\":\"https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/97979928-1e7f-4a22-b4cf-e7db2e95207b/id-preview-f1a7a5f9--67fbfdeb-ef3a-43b8-a184-79622d436225.lovable.app-1781074340903.png\",\"address\":{\"@type\":\"PostalAddress\",\"addressLocality\":\"Mangalore\",\"addressRegion\":\"Karnataka\",\"addressCountry\":\"IN\"}}"
  }
]
  }),
...
function PageComponent() {
  return (
    <SharedLayout>
      <HeroBanner title={"WordPress Developer in Mangalore"} />
      ...
      >
        <div className="prose prose-invert prose-lg max-w-none prose-headings:font-display">
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">Looking for a WordPress developer in Mangalore who builds fast, SEO-friendly sites without unnecessary plugins slowing things down? That's exactly what we do.</p>
