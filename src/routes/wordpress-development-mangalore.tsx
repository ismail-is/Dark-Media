  ...
  head: () => ({
    meta: [
      ...
      { title: "WordPress Developer in Mangalore | Dark Media" },
      {
        name: "description",
        content:
          "Affordable, professional WordPress website development in Mangalore. Fast delivery, SEO-friendly builds.",
      },
      ...
      >
        <div className="prose prose-invert prose-lg max-w-none prose-headings:font-display">
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            Looking for a WordPress developer in Mangalore who builds fast, SEO-friendly sites
            without unnecessary plugins slowing things down? That's exactly what we do.
          </p>
