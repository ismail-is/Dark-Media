  ...
  head: () => ({
    meta: [
      ...
      { title: "SEO Company in Mangalore | Rank #1 on Google | Dark Media" },
      {
        name: "description",
        content:
          "Local SEO experts in Mangalore. On-page, off-page & technical SEO that gets real rankings. Free SEO audit available.",
      },
      {
        property: "og:title",
        content: "SEO Company in Mangalore | Rank #1 on Google | Dark Media",
      },
      {
    ...
    scripts: [
      ...
      },
      {
        type: "application/ld+json",
        children:
          '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Do you guarantee #1 rankings?","acceptedAnswer":{"@type":"Answer","text":"No ethical SEO agency can guarantee a specific rank — we guarantee a structured process and measurable progress."}},{"@type":"Question","name":"How is SEO different from Google Ads?","acceptedAnswer":{"@type":"Answer","text":"SEO is organic and long-term; ads are paid and immediate. Most businesses benefit from both."}}]}',
      },
    ],
  }),
      ...
      >
        <div className="prose prose-invert prose-lg max-w-none prose-headings:font-display">
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            Ranking on the first page of Google isn't luck — it's a structured process. Dark Media
            runs full-spectrum SEO for Mangalore businesses: technical fixes, content, and local
          ...
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            Most searches have local intent — "best [service] in Mangalore." We optimise
            specifically for that, including citations on local directories.
          </p>
          ...
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            ...
            No ethical SEO agency can guarantee a specific rank — we guarantee a structured process
          ...
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            ...
            SEO is organic and long-term; ads are paid and immediate. Most businesses benefit from
            both.
          </p>
