...
export const Route = createFileRoute('/graphic-design')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: "Creative graphic design for print & digital — social media creatives, brochures, packaging & more." },
    ...
    scripts: [
  {
    ...
    "children": "{\"@context\":\"https://schema.org\",\"@type\":\"ProfessionalService\",\"name\":\"Dark Media\",\"description\":\"Creative graphic design for print & digital — social media creatives, brochures, packaging & more.\",\"url\":\"https://darkmedia.tech/graphic-design\",\"telephone\":\"+919480889252\",\"email\":\"hello@darkmedia.tech\",\"image\":\"https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/97979928-1e7f-4a22-b4cf-e7db2e95207b/id-preview-f1a7a5f9--67fbfdeb-ef3a-43b8-a184-79622d436225.lovable.app-1781074340903.png\"}"
  }
]
  }),
...
function PageComponent() {
  return (
    <SharedLayout>
      <HeroBanner title={"Graphic Design Services"} />
      ...
      >
        <div className="prose prose-invert prose-lg max-w-none prose-headings:font-display">
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">From social media creatives to packaging and print collateral, Dark Media's design team creates visuals consistent with your brand identity.</p>
