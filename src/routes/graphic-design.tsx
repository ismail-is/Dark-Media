  ...
  head: () => ({
    meta: [
      ...
      { title: "Graphic Design Services | Dark Media" },
      {
        name: "description",
        content:
          "Creative graphic design for print & digital — social media creatives, brochures, packaging & more.",
      },
      ...
      >
        <div className="prose prose-invert prose-lg max-w-none prose-headings:font-display">
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            From social media creatives to packaging and print collateral, Dark Media's design team
            creates visuals consistent with your brand identity.
          </p>
