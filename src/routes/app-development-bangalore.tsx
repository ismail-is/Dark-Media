...
export const Route = createFileRoute("/app-development-bangalore")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Android & iOS app developers in Bangalore — from idea to App Store launch.",
      },
      ...
      {
        name: "twitter:title",
        content: "Mobile App Development Company in Bangalore | Dark Media",
      },
      {
      ...
      >
        <div className="prose prose-invert prose-lg max-w-none prose-headings:font-display">
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            Bangalore is India's startup capital, and we build apps that can scale with fast-growing
            companies — from MVP to full product.
          </p>
