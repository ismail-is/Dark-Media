  ...
  head: () => ({
    meta: [
      ...
      { title: "Best Digital Marketing Agency in Mangalore | Dark Media" },
      {
        name: "description",
        content:
          "SEO, social media & PPC experts helping Mangalore businesses grow online. Free consultation — call Dark Media today.",
      },
      ...
      >
        <div className="prose prose-invert prose-lg max-w-none prose-headings:font-display">
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            Growing a business in Mangalore means standing out in a market where more customers now
            start with a Google or Instagram search than a walk-in. Dark Media builds digital
            marketing strategies — SEO, social media, and paid ads — specifically for Mangalore's
            local market.
          </p>
          ...
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            A Mangalore-based bakery, clinic, or retail store competes differently than a national
            brand. We tailor keyword targeting, ad locations, and content to local search behaviour,
          ...
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            <em className="text-[#F5F5F4]/90 not-italic font-medium block mt-6 mb-2">
              How much does digital marketing cost in Mangalore?
            </em>{" "}
            Packages typically start based on scope — contact us for a free quote tailored to your
            goals.
          </p>
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            <em className="text-[#F5F5F4]/90 not-italic font-medium block mt-6 mb-2">
            ...
            SEO takes 3-6 months for meaningful ranking movement; paid ads can drive traffic within
            days.
          </p>
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            <em className="text-[#F5F5F4]/90 not-italic font-medium block mt-6 mb-2">
            ...
            Yes — we work with startups, local shops, and larger companies alike.
          </p>
