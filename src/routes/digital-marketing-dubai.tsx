  ...
  head: () => ({
    meta: [
      ...
      { title: "Digital Marketing Agency in Dubai | Dark Media" },
      {
        name: "description",
        content:
          "Dubai-based digital marketing services — SEO, paid ads & branding for UAE businesses. Book a free strategy call.",
      },
      ...
      >
        <div className="prose prose-invert prose-lg max-w-none prose-headings:font-display">
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            The UAE market moves fast, and Dubai customers expect polished, mobile-first digital
            experiences. Dark Media helps Dubai businesses build a strong digital presence with SEO,
            paid advertising, and content that fits the local market.
          </p>
          ...
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            We understand that Dubai audiences span both residents and a large international
            customer base — your marketing needs to speak to both without feeling generic.
          </p>
          ...
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            <em className="text-[#F5F5F4]/90 not-italic font-medium block mt-6 mb-2">
              Do you offer Arabic content?
            </em>{" "}
            Yes, available on request depending on project scope.
          </p>
          <p className="mb-6 text-lg md:text-xl text-[#F5F5F4]/60 leading-relaxed font-light">
            <em className="text-[#F5F5F4]/90 not-italic font-medium block mt-6 mb-2">
              Can you manage ad campaigns targeting the whole GCC?
            </em>{" "}
            Yes, campaigns can be scoped beyond Dubai on request.
          </p>
