...
function StackingSection({ children, index, bgColor = "bg-[#030304]" }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
    ref: sectionRef,
    className: `${isMobile ? "relative h-auto py-4 md:py-8" : "sticky top-0 h-screen overflow-hidden"} w-full ${bgColor}`,
    style: {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                        ...
                        children: ["#D5161B", "#D7AE43", "#000000", "#D0D0D0"].map((color) =>
