...
function StackingSection({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: sectionRef, className: `${isMobile ? "relative h-auto py-4 md:py-8" : "sticky top-0 h-screen overflow-hidden"} w-full ${bgColor}`, style: {
...
function PortfolioPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "relative bg-[#030304] text-[#F5F5F4] min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative min-h-[40vh] md:min-h-[50vh] flex flex-col items-center justify-center pt-32 pb-16 overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(StackingSection, { index: 1, children: /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "px-4 sm:px-6 md:px-10 lg:p-[220px] py-10 md:py-16 lg:py-20 relative z-10 bg-[#F5F5F4] w-full rounded-[24px] md:rounded-[32px] lg:rounded-t-[48px] lg:rounded-b-none shadow-2xl border border-black/5 lg:border-t lg:border-x-0 lg:border-b-0 ", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1600px] mx-auto w-full", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-b border-[#030304]/10 pb-4 mb-6 flex flex-col lg:flex-row lg:items-end justify-between gap-6  md:-mt-16", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sm:col-span-1 bg-white rounded-[16px] md:rounded-[20px] overflow-hidden border border-[#030304]/5 shadow-md hover:shadow-xl transition-all duration-500 relative group h-auto flex flex-col", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: img6, alt: "Mockup Presentation", className: "w-full h-auto object-cover transition-transform duration-700 group-hover:scale-110 flex-grow" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sm:col-span-1 flex flex-col gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white rounded-[16px] md:rounded-[20px] overflow-hidden border border-[#030304]/5 shadow-md hover:shadow-xl transition-all duration-500 relative group h-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: img1, alt: "Corporate Stationery", className: "w-full h-auto object-cover transition-transform duration-700 group-hover:scale-110" }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-[160px] sm:col-span-2 rounded-[16px] md:rounded-[20px] p-4 md:p-6 flex items-center justify-center border border-[#030304]/5 shadow-md hover:shadow-xl transition-all duration-500 relative overflow-hidden group", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: img2, alt: "Logo Geometry breakdown", className: "w-full sm:w-auto h-auto max-h-full max-w-full object-contain mix-blend-multiply transition-transform duration-700 group-hover:scale-105" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-[16px] md:rounded-[20px] overflow-hidden border border-[#030304]/5 shadow-md hover:shadow-xl transition-all duration-500 relative group h-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: img3, alt: "Brand Typography Details", className: "w-full h-auto object-cover transition-transform duration-700 group-hover:scale-110" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-[16px] md:rounded-[20px] overflow-hidden border border-[#030304]/5 shadow-md hover:shadow-xl transition-all duration-500 relative group h-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: img5, alt: "Brand Typography Mockup", className: "w-full h-auto object-cover transition-transform duration-700 group-hover:scale-110" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 ring-1 ring-inset ring-black/5 rounded-[16px] md:rounded-[20px]" })
        ] })
      ] })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(StackingSection, { index: 2, children: /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: " px-4 sm:px-6 md:px-10 lg:p-[220px] py-10 md:py-16 lg:py-20 relative z-10 bg-[#F5F5F4] w-full rounded-[24px] md:rounded-[32px] lg:rounded-t-[48px] lg:rounded-b-none shadow-2xl border border-black/5 lg:border-t lg:border-x-0 lg:border-b-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1600px] mx-auto w-full", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-12 md:grid-rows-4 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-5 md:row-span-2 bg-[#1A1A1A] rounded-[20px] flex items-center justify-center border border-[#030304]/5 shadow-md hover:shadow-xl transition-all duration-500 overflow-hidden group ", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: img8, alt: "Al Masoudi Logo", className: "object-contain transition-transform duration-700 group-hover:scale-110" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-3 md:row-span-2 md:col-start-6 bg-white rounded-[20px] overflow-hidden border border-[#030304]/5 shadow-md hover:shadow-xl transition-all duration-500 group", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: img9, alt: "Mockup Presentation", className: "w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-4 md:row-span-2 md:col-start-9 bg-white rounded-[20px] overflow-hidden border border-[#030304]/5 shadow-md hover:shadow-xl transition-all duration-500 group", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: img10, alt: "Corporate Stationery", className: "w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-6 md:row-span-2 md:row-start-3 bg-white rounded-[20px] flex items-center justify-center border border-[#030304]/5 shadow-md hover:shadow-xl transition-all duration-500 overflow-hidden group ", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: img11, alt: "Logo Geometry Breakdown", className: "object-contain p-4 transition-transform duration-700 group-hover:scale-105" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-4 md:row-span-2 md:col-start-7 md:row-start-3 bg-white rounded-[20px] overflow-hidden border border-[#030304]/5 shadow-md hover:shadow-xl transition-all duration-500 group", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: img12, alt: "Brand Typography", className: "w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2 md:row-span-2 md:col-start-11 md:row-start-3 bg-white rounded-[20px] p-4 border border-[#030304]/5 shadow-md hover:shadow-xl transition-all duration-500 flex flex-col justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] uppercase tracking-widest text-[#030304]/50 font-mono", children: "Brand Palette" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-[#D5161B] animate-pulse" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3 mt-4", children: ["#D5161B", "#D7AE43", "#000000", "#D0D0D0"].map((color) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-14 rounded-lg border border-black/5 shadow-inner hover:scale-105 transition-transform", style: {
              backgroundColor: color
            } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-mono text-[#030304]/70 text-center break-all", children: color })
          ] }, color)) })
        ] })
      ] })
    ] }) }) }),
